...
//#endregion
//#region frontend/src/components/AdminPanel.jsx
function AdminPanel({
  user,
  adminProductForm,
  setAdminProductForm,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)(
    ...
    {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)("section", {
          className: "rounded-lg border bg-white p-4 shadow-sm space-y-3",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)("h2", {
              className: "text-lg font-semibold",
              children: "Admin Product Create",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)("form", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)("input", {
                  ...
                  type: "number",
                  value: adminProductForm.priceCents,
                  onChange: (e) =>
                    setAdminProductForm({
                      ...adminProductForm,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)("section", {
          className:
            "rounded-lg border bg-white p-4 shadow-sm space-y-3 lg:col-span-2",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)("h2", {
              className: "text-lg font-semibold",
            ...
            !user || user.role !== "admin"
              ...
              : adminOrders.length
                ? /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)("div", {
                    className: "grid gap-2",
                    children: adminOrders.map((o) =>
                      /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)(
                              "select",
                              {
                                className: "mt-2 rounded border p-2",
                                value: o.order_status,
                                onChange: (e) =>
                                  onUpdateOrderStatus(o.id, e.target.value),
                                children: [
                                  "pending",
                                  "processing",
                                  "shipped",
...
var init_AdminPanel = __esmMin(() => {
  init_api();
  import_jsx_runtime$7 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/components/AuthPanel.jsx
function AuthPanel({
  registerForm,
  setRegisterForm,
  loginForm,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime$6.jsxs)("section", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime$6.jsxs)("form", {
        className: "grid gap-2",
        onSubmit: onRegister,
        children: [
...
var init_AuthPanel = __esmMin(() => {
  import_jsx_runtime$6 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/components/CartPanel.jsx
function CartPanel({ token, cart, subtotal, onIncrement, onRemove }) {
  return /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("section", {
    className: "rounded-lg border bg-white p-4 shadow-sm space-y-3",
    children: [
      ...
      !token
        ...
        : cart.length
          ? /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("div", {
              ...
              children: [
                cart.map((item) =>
                  /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)(
                    "div",
                    {
                      className: "rounded border p-3",
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)(
                              "button",
                              {
                                className:
                ...
                /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("p", {
                  ...
                  children: ["Subtotal: ", money(subtotal)],
                }),
              ],
            })
          : /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("p", {
...
var init_CartPanel = __esmMin(() => {
  init_api();
  import_jsx_runtime$5 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/components/CatalogPanel.jsx
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime$4.jsxs)("section", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime$4.jsxs)("select", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("option", {
            value: "",
            children: "All Categories",
          }),
          categories.map((c) =>
            /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(
              "option",
              {
                value: c.id,
                children: c.name,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("div", {
        ...
        children: products.length
          ? products.map((p) =>
              /* @__PURE__ */ (0, import_jsx_runtime$4.jsxs)(
                "div",
                {
                  className: "rounded border p-3",
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("button", {
                      className:
                        "mt-2 rounded bg-blue-600 px-3 py-1.5 text-white",
...
var init_CatalogPanel = __esmMin(() => {
  init_api();
  import_jsx_runtime$4 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/components/CheckoutPanel.jsx
function CheckoutPanel({ checkoutForm, setCheckoutForm, onCheckout }) {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("input", {
            ...
            onChange: (e) =>
              setCheckoutForm({
                ...checkoutForm,
                shippingContact: e.target.value,
              }),
            required: true,
          }),
          /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("select", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("option", {
                value: "pending",
                children: "pending",
              }),
              /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("option", {
...
var init_CheckoutPanel = __esmMin(() => {
  import_jsx_runtime$3 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/components/OrdersPanel.jsx
function OrdersPanel({ token, orders }) {
    ...
    children: [
      ...
      !token
        ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("p", {
            className: "text-sm text-slate-600",
            children: "Login to view your orders.",
          })
        : orders.length
          ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
              className: "space-y-2",
              children: orders.map((o) =>
                /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)(
                  "div",
                  {
...
var init_OrdersPanel = __esmMin(() => {
  init_api();
  import_jsx_runtime$2 = require_jsx_runtime();
});
//#endregion
//#region frontend/src/hooks/useAdmin.js
function useAdmin(api, user, onError) {
  const [adminOrders, setAdminOrders] = (0, import_react$6.useState)([]);
  const [adminProductForm, setAdminProductForm] = (0, import_react$6.useState)({
    name: "",
    description: "",
    imageUrl: "",
    priceCents: "",
    ...
    return api("/api/admin/products", {
      ...
      body: JSON.stringify({
        ...
        categoryId: adminProductForm.categoryId
          ? Number(adminProductForm.categoryId)
          : null,
      }),
    });
  }
...
//#endregion
//#region frontend/src/hooks/useAuth.js
function useAuth() {
  const [token, setToken] = (0, import_react$5.useState)(
    localStorage.getItem("token") || "",
  );
  const [user, setUser] = (0, import_react$5.useState)(
    JSON.parse(localStorage.getItem("user") || "null"),
  );
  const [registerForm, setRegisterForm] = (0, import_react$5.useState)({
    name: "",
    email: "",
    password: "",
  });
  const [loginForm, setLoginForm] = (0, import_react$5.useState)({
    email: "",
    password: "",
  });
...
var import_react$5;
var init_useAuth = __esmMin(() => {
  import_react$5 = /* @__PURE__ */ __toESM(require_react());
  init_api();
});
//#endregion
//#region frontend/src/hooks/useCart.js
function useCart(api, token, onError) {
  const [cart, setCart] = (0, import_react$4.useState)([]);
  ...
  return {
    cart,
    subtotal: (0, import_react$4.useMemo)(
      () =>
...
var import_react$4;
var init_useCart = __esmMin(() => {
  import_react$4 = /* @__PURE__ */ __toESM(require_react());
});
//#endregion
//#region frontend/src/hooks/useCatalog.js
function useCatalog(api, onError) {
  const [categories, setCategories] = (0, import_react$3.useState)([]);
  const [categoryId, setCategoryId] = (0, import_react$3.useState)("");
  const [products, setProducts] = (0, import_react$3.useState)([]);
  const loadCategories = async () => {
    setCategories(await api("/api/categories"));
  };
  const loadProducts = async () => {
    setProducts(
      await api(`/api/products${categoryId ? `?category=${categoryId}` : ""}`),
    );
  };
...
var import_react$3;
var init_useCatalog = __esmMin(() => {
  import_react$3 = /* @__PURE__ */ __toESM(require_react());
});
//#endregion
//#region frontend/src/hooks/useOrders.js
function useOrders(api, token, onError) {
  const [orders, setOrders] = (0, import_react$2.useState)([]);
  const [checkoutForm, setCheckoutForm] = (0, import_react$2.useState)({
    shippingName: "",
    shippingAddress: "",
    shippingContact: "",
...
var import_react$2;
var init_useOrders = __esmMin(() => {
  import_react$2 = /* @__PURE__ */ __toESM(require_react());
});
//#endregion
//#region frontend/src/App.jsx
function App() {
  const [status, setStatus] = (0, import_react$1.useState)("Ready");
  const {
    token,
    user,
    registerForm,
  ...
  const { categories, categoryId, setCategoryId, products, loadProducts } =
    useCatalog(api, setStatus);
  const { cart, subtotal, loadCart, addToCart, increment, remove } = useCart(
    api,
    token,
    setStatus,
  );
  const { orders, checkoutForm, setCheckoutForm, loadOrders, checkout } =
    useOrders(api, token, setStatus);
  const {
    adminOrders,
    adminProductForm,
    setAdminProductForm,
  ...
  const refreshAll = async () =>
    Promise.all([loadProducts(), loadCart(), loadOrders(), loadAdminOrders()]);
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("main", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(AuthPanel, {
              registerForm,
              setRegisterForm,
              loginForm,
              setLoginForm,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(CatalogPanel, {
              categories,
              categoryId,
              setCategoryId,
              products,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(CartPanel, {
              token,
              cart,
              subtotal,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(CheckoutPanel, {
              checkoutForm,
              setCheckoutForm,
              onCheckout: async (e) => {
                e.preventDefault();
                if (!token) return setStatus("Please login first.");
                try {
                  setStatus(`Order #${(await checkout()).id} placed.`);
                  await refreshAll();
                } catch (err) {
                  setStatus(err.message);
                }
            ...
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(OrdersPanel, {
              token,
              orders,
            }),
            /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(AdminPanel, {
              user,
              adminProductForm,
              setAdminProductForm,
              adminOrders,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("p", {
          className:
            "sticky bottom-0 rounded bg-slate-900 px-3 py-2 text-sm text-white",
          children: status,
        }),
      ],
    }),
...
//# sourceMappingURL=index-C0t9eJ03.js.map
